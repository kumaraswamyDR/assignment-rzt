...
export default function Home() {
    ...
    return (
        <div>
            <div className={styles.searchBarContainer}><SearchBar onSearch={onSearch}/></div>
            <div className={styles.row}>
                {(mediaFiles && mediaFiles.length>0) && mediaFiles.map(media => {
                    return <div key={media.id} className={styles.mediaLayout}>
